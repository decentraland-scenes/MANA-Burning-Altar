...
items:
  ...
  - uid: decentraland-ecs.Input.subscribe
    ...
    type: method
    syntax:
      content: 'subscribe(eventName: InputEventKind, fn: (e: LocalPointerEvent) => void): () => void;'
      return:
        type:
          - () => void
        description: ''
  ...
  - uid: decentraland-ecs.Input.unsubscribe
    ...
    type: method
    syntax:
      content: 'unsubscribe(eventName: InputEventKind, fn: (e: LocalPointerEvent) => void): void;'
      return:
        type:
          - void
        description: ''
