...
items:
  - uid: decentraland-ecs.Quaternion
    ...
    children:
      ...
      - decentraland-ecs.Quaternion.toEulerAnglesToRef
  ...
  - uid: decentraland-ecs.Quaternion.Angle
    ...
    type: method
    syntax:
      content: 'static Angle(quat1: Quaternion, quat2: Quaternion): number;'
      return:
        type:
          - number
        description: ''
  ...
  - uid: decentraland-ecs.Quaternion.AreClose
    ...
    type: method
    syntax:
      content: 'static AreClose(quat0: Quaternion, quat1: Quaternion): boolean;'
      return:
        type:
          - boolean
  ...
  - uid: decentraland-ecs.Quaternion.copyFrom
    ...
    type: method
    syntax:
      content: 'copyFrom(other: Quaternion): Quaternion;'
      return:
        type:
          - decentraland-ecs.Quaternion
  ...
  - uid: decentraland-ecs.Quaternion.Dot
    ...
    type: method
    syntax:
      content: 'static Dot(left: Quaternion, right: Quaternion): number;'
      return:
        type:
          - number
  ...
  - uid: decentraland-ecs.Quaternion.equals
    ...
    type: method
    syntax:
      content: 'equals(otherQuaternion: Quaternion): boolean;'
      return:
        type:
          - boolean
  ...
  - uid: decentraland-ecs.Quaternion.Hermite
    ...
    syntax:
      content: >-
        static Hermite(value1: Quaternion, tangent1: Quaternion, value2: Quaternion, tangent2: Quaternion, amount:
        number): Quaternion;
      return:
        type:
          - decentraland-ecs.Quaternion
  ...
  - uid: decentraland-ecs.Quaternion.IsIdentity
    ...
    type: method
    syntax:
      content: 'static IsIdentity(quaternion: Quaternion): boolean;'
      return:
        type:
          - boolean
  ...
  - uid: decentraland-ecs.Quaternion.multiply
    ...
    type: method
    syntax:
      content: 'multiply(q1: Quaternion): Quaternion;'
      return:
        type:
          - decentraland-ecs.Quaternion
  ...
  - uid: decentraland-ecs.Quaternion.multiplyInPlace
    ...
    type: method
    syntax:
      content: 'multiplyInPlace(q1: Quaternion): Quaternion;'
      return:
        type:
          - decentraland-ecs.Quaternion
  ...
  - uid: decentraland-ecs.Quaternion.multiplyToRef
    ...
    type: method
    syntax:
      content: 'multiplyToRef(q1: Quaternion, result: Quaternion): Quaternion;'
      return:
        type:
          - decentraland-ecs.Quaternion
        description: the current quaternion
  ...
  - uid: decentraland-ecs.Quaternion.RotateTowards
    ...
    type: method
    syntax:
      content: 'static RotateTowards(from: Quaternion, to: Quaternion, maxDegreesDelta: number): Quaternion;'
      return:
        type:
          - decentraland-ecs.Quaternion
        description: ''
  ...
  - uid: decentraland-ecs.Quaternion.Slerp
    ...
    type: method
    syntax:
      content: 'static Slerp(left: Quaternion, right: Quaternion, amount: number): Quaternion;'
      return:
        type:
          - decentraland-ecs.Quaternion
        description: the new interpolated quaternion
  ...
  - uid: decentraland-ecs.Quaternion.SlerpToRef
    ...
    type: method
    syntax:
      content: 'static SlerpToRef(left: Quaternion, right: Quaternion, amount: number, result: Quaternion): void;'
      return:
        type:
          - void
        description: ''
    ...
    syntax:
      ...
      parameters:
        - id: other
          ...
          type:
            - decentraland-ecs.Quaternion
  - uid: decentraland-ecs.Quaternion.toEulerAnglesToRef
    summary: Sets the given vector3 "result" with the Euler angles translated from the current quaternion
    name: 'toEulerAnglesToRef(result, order)'
    fullName: toEulerAnglesToRef
    langs:
      - typeScript
    type: method
    syntax:
      content: 'toEulerAnglesToRef(result: Vector3, order?: string): Quaternion;'
      return:
        type:
          - decentraland-ecs.Quaternion
      ...
      parameters:
        - id: result
          description: defines the vector which will be filled with the Euler angles
          type:
            - decentraland-ecs.Vector3
        - id: order
          description: is a reserved parameter and is ignore for now
          type:
            - string
